...
#[cfg(feature = "trace")]
pub fn syn_trace(net_info: NetInfo, timeout: Duration) -> Result<u8, PistolError> {
...
#[cfg(any(feature = "trace", feature = "os"))]
pub fn icmp_trace(net_info: NetInfo, timeout: Duration) -> Result<u8, PistolError> {
    let mut rng = rand::rng();
...
#[cfg(feature = "trace")]
pub fn udp_trace(net_info: NetInfo, timeout: Duration) -> Result<u8, PistolError> {
    let dst_mac = net_info.dst_mac;
    let dst_addr = net_info.dst_addr;
    let src_mac = net_info.src_mac;
    let src_addr = net_info.src_addr;
