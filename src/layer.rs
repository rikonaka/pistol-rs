...
pub(crate) struct Layer4FilterTcpUdp {
    ...
    pub(crate) flag: Option<u8>,      // response tcp packet flag, only for tcp packet
}
...
pub(crate) fn ipv6_solicited_node_multicast_mac(ip: Ipv6Addr) -> MacAddr {
...
pub(crate) fn ipv6_all_routers_multicast_mac() -> MacAddr {
    // 33:33:00:00:00:02
...
mod tests {
    ...
    fn test_layer_match() {
        ...
        let layer4_icmp = Layer4FilterIcmp {
            name: String::from("test icmp").to_string(),
            layer3: Some(layer3),
            icmp_type: None,
            icmp_code: None,
    ...
    fn test_layer_match2() {
        ...
        let layer4_icmpv6 = Layer4FilterIcmpv6 {
            name: String::from("test icmpv6").to_string(),
            layer3: Some(layer3),
    ...
    fn test_layer_match5() {
        ...
        let layer4_tcp_udp = Layer4FilterTcpUdp {
            name: String::from("test tcp_udp").to_string(),
            layer3: Some(layer3),
